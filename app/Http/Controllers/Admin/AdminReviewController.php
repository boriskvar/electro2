...
class AdminReviewController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.products.show', $request->product_id)->with('success', 'Отзыв успешно добавлен!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //return redirect()->route('admin.products.show', $review->product_id)->with('success', 'Отзыв успешно обновлен!');
        // Перенаправляем обратно с сообщением об успешном обновлении
        return redirect()->route('admin.reviews.index', $review['id'])->with('success', 'Отзыв успешно обновлен!');
    }
