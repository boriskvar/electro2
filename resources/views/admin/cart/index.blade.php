    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <form action="{{ route('admin.cart.remove', $item->id) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
...
<form action="{{ route('admin.cart.add') }}" method="POST" class="form-inline">
    ...
    <div class="form-group mx-sm-3">
        ...
        <input type="number" name="quantity" id="quantity" class="form-control" placeholder="Количество" value="1" min="1" required>
    </div>
