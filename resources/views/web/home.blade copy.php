            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="shop">
                    ...
                    <div class="shop-body">
                        ...
                        {{-- <a href="{{ route('store', ['category' => $category->id, 'discount' => 1]) }}"
                        class="cta-btn"> --}}
                        {{-- <a href="{{ route('store', ['hot-deals' => 1]) }}" class="cta-btn"> --}}
                            ...
                            <div class="products-slick" data-nav="#slick-nav-{{ $category->id }}">
                                ...
                                <div class="product">
                                    <div class="product-img">
                                        <img src="{{ asset('storage/img/' . $product['images'][0]) }}"
                                             alt="{{ $product['name'] }}">
                                        @if($product->discount)
...
<div id="hot-deal" class="section"
     style="background-image: url('{{ asset('storage/img/hotdeal.png') }}'); background-position: center; background-repeat: no-repeat; background-size: cover;">
    <!-- container -->
    <div class="container">
        <!-- row -->
        <div class="row">
            <div class="col-md-12">
                <div class="hot-deal">
                    ...
                    {{-- <a class="primary-btn cta-btn" href="{{ route('store', ['hot-deals' => 1]) }}">Shop now</a>
                    --}}
                </div>
            </div>
        </div>
                    ...
                    <div class="products-tabs">
                        ...
                        <div id="tab-top-{{ $category->id }}" class="tab-pane {{ $loop->first ? 'active' : '' }}">
                            <div class="products-slick" data-nav="#slick-nav-top-{{ $category->id }}">
                                ...
                                @foreach($productsByCategory[$category->name]->where('is_top_selling', 1) ?? [] as
                                $product)
