                    ...
                    <div class="aside">
                        ...
                        <div class="price-filter">
                            ...
                            <div class="input-number price-min">
                                <input id="price-min" type="number" name="min_price" value="{{ request('min_price', $minPrice ?? 0) }}" step="0.1">
                                <span class="qty-up">+</span>
                                <span class="qty-down">-</span>
                            </div>
                            <span>-</span>
                            <div class="input-number price-max">
                                <input id="price-max" type="number" name="max_price" value="{{ request('max_price', $maxPrice ?? 2000) }}" step="0.1">
                                <span class="qty-up">+</span>
                                <span class="qty-down">-</span>
                            </div>
                        </div>
