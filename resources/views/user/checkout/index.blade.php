...
<div class="section">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="shiping-details">
                    ...
                    <div class="input-checkbox">
                        <input type="checkbox" id="shiping-address" name="shipping_address">
                        ...
                        <div class="caption">
                            ...
                            <div class="form-group">
                                <input class="input" type="text" name="shipping_first-name" placeholder="First Name">
                            </div>
                            <div class="form-group">
                                <input class="input" type="text" name="shipping_last-name" placeholder="Last Name">
                            </div>
                            <div class="form-group">
    ...
    <div class="payment-method">
        <div class="input-radio">
            <input type="radio" name="payment_method" id="payment-1" value="bank_transfer" required>
        ...
        <div class="input-radio">
            <input type="radio" {{-- name="payment" --}} name="payment_method" id="payment-2" value="cheque" required>
            <label for="payment-2">
                <span></span>
                Cheque Payment
            </label>
        ...
        <div class="input-radio">
            <input type="radio" {{-- name="payment" --}} name="payment_method" id="payment-3" value="paypal" required>
            <label for="payment-3">
                <span></span>
                Paypal System
            </label>
